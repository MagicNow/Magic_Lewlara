<?php 
$header_title = 'Concorrente Excluído';
?>
...
@section('content')
		...
		<div class="col-sm-9  col-md-9 main usuario sucesso">
						...
						<p class="col-sm-8 novo-usuario-sucesso-descricao">
							Concorrente {{$concorrente->name}} excluído com sucesso!  <br />
						</p>
						
						<div class="row">
							<div class="col-sm-12">
								{!! link_to_action('ConcorrenteController@todos','IR PARA TODOS CONCORRENTES',$concorrente->cliente->slug,['class'=>'btn btn-amarelo btn-medio']) !!}
							</div><!-- /.col-sm-12 -->
						</div><!-- /.row -->
