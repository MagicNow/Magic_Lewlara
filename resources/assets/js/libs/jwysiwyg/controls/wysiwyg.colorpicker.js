...
(function ($) {
	...
	$.wysiwyg.controls.colorpicker = {
		...
		init: function (Wysiwyg) {
			...
			dialogReplacements = {
				legend: "Escolha a Cor",
				color: "Cor",
				applyForeColor: "Definir Texto",
				applyBgColor: "Definir Fundo",
				reset: "Cancelar"
			};
			...
			if ($.modal) {
				...
				if ($.farbtastic) {
					elements = $("<div/>")
						.css({"position": "fixed",
							"z-index": 2000,
							"left": "50%", "top": "50%", "background": "rgb(255, 255, 255)","border":'1px solid #e5e5e5','box-shadow':'0px 0px 12px 4px #e5e5e5' ,
