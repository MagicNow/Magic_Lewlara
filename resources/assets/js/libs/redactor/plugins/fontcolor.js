	...
	$.Redactor.prototype.fontcolor = function()
	{
		return {
			...
			buildPicker: function($dropdown, name, colors)
			{
				...
				var $elNone = $('<a href="#" style="display: block; clear: both; padding: 5px; font-size: 12px; line-height: 1;"></a>').html('Padrão');
